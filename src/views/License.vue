...
export default {
  ...
  metaInfo: {
      title: "Licenses",
      titleTemplate: '%s | Ready Set Dice',
      htmlAttrs: {
        lang: 'en-US'
      },
      meta: [
        { charset: 'utf-8' },
        { name: 'description', content: `Ready Set Dice is licensed under the CUP and OGL.
        RSD is a Pathfinder 2nd edition tool that helps GM's and players alike in running their game.` },
